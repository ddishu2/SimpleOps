...
{  
    ...
    {
        $so_from_date   =   $this->input->get(open_so::C_FROM_DATE);
       $so_to_date      =   $this->input->get(open_so::C_TO_DATE);
       $lv_so_projname  =   $this->input->get(open_so::C_PROJ_NAME);
       $lv_so_proj_bu   =   $this->input->get(open_so::C_PROJ_BU);
       $larr_so_locs    =   $this->input->get(open_so::C_PROJ_LOC);
       $fp_v_proj_id    =   $this->input->get(open_so::C_PROJ_ID);
       $fp_v_capability =   $this->input->get(open_so::C_CAPABILITY);
       $fp_v_cust_name  =   $this->input->get(open_so::C_CUST_NAME);
...
//       echo 'end date'.$so_to_date;
        ...
        $lt_open_sos = $this->m_proposals->getAutoProposals();
