...
/**
 * Description of cl_SOEmpSkillMatcher
 *
 * @author rkumthek 23/11/2015
 */
...
//            echo 'Emp Skills WA'.json_encode($lwa_skill,JSON_PRETTY_PRINT).PHP_EOL;
            ...
            $larr_alt_skills1 = array_slice($lwa_skill, self::C_ALT_SKILL_MIN_INDEX, self::C_ALT_SKILL_MAX_INDEX);
            $larr_alt_skills = array_values($larr_alt_skills1);
