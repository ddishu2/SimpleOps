...
//     const C_FNAME_EDATE    = 'lock_end_date';
    ...
    const C_TAG_TYPE = 'tag_type';   
     ...
     const C_HARDLOCK_RELEASE ='v_hard_lock_release';
...
//   }    
    ...
    public function gethardlockdata($fp_start_date){
       $arr_result = [];
       $this->db->select('emp_id,emp_name,svc_line ,so_proj_id,so_proj_name,lock_start_date,lock_end_date,so_id,so_level ,sup_id,sup_name,smart_proj_code,FTE,tag_type,updated_by,updated_on');
...
//       print_r($arr_result_final);
    ...
    return $arr_result_final;
     ...
     public function gethardlockreleasedata($fp_start_date , $fp_end_date){
