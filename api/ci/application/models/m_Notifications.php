...
//      $lv_mail = mail($this->lv_recievers, $this->lv_subject, $this->lv_message, $this->lv_headers);              \
        ...
        $lv_mail = mail('dikshant.mishra@capgemini.com;tejas.nakwa@capgemini.com;alice.kolatkar@capgemini.com; praveen.kumaran@capgemini.com;sumit.naik@capgemini.com', $this->lv_subject, $this->lv_message, $this->lv_headers);                     
        if ($lv_mail) {
            return true;
        } else {
            return false;
